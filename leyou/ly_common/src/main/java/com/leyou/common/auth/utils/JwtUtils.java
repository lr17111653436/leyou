...
public class JwtUtils {
    ...
    /*public static void main(String[] args) throws Exception {
        UserInfo info = new UserInfo(1L,"jack Ma","admin");
        String privateKeyFilename="E:\\worksoft\\javaee96\\ssh\\id_rsa";
        PrivateKey privateKey = RsaUtils.getPrivateKey(privateKeyFilename);
       // String token = generateTokenExpireInMinutes(info, privateKey, 5);
        //System.out.println(token);
        String token ="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c";
        String publicKeyFilename="E:\\worksoft\\javaee96\\ssh\\id_rsa.pub";
        PublicKey publicKey = RsaUtils.getPublicKey(publicKeyFilename);
        Payload<UserInfo> payload = getInfoFromToken(token, publicKey, UserInfo.class);
